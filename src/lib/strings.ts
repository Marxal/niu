...
export const strings = {
  ...
  calendar: {
    ...
    eventPlaceholder: 'Dinner with Anna',
    reminderPlaceholder: 'Renew the parking permit',
    whenLabel: 'When',
    startsLabel: 'Starts',
    endsLabel: 'Ends',
    allDayLabel: 'All day',
    ...
    whoEveryone: 'Nobody picked means all of you.',
    whereLabel: 'Where',
    wherePlaceholder: 'Optional',
    notesLabel: 'Notes',
    notesPlaceholder: 'Anything worth remembering',
    colourLabel: 'Colour',
    moreLabel: 'More — place, notes, colour',
    save: 'Save',
    saveAdd: 'Add it',
    cancel: 'Cancel',
    remove: 'Remove',
    ...
    asking: 'Sending…',
    unask: 'Never mind, drop the question',
    waiting: 'Waiting',
